...
type QueryAccountsResponse struct {
	// repeated Account accounts = 1 [(gogoproto.nullable) = false, (gogoproto.castrepeated) = "Accounts"];
...
type QueryPaymentsResponse struct {
	// repeated Payment payments = 1 [(gogoproto.nullable) = false, (gogoproto.castrepeated) = "Payments"];
